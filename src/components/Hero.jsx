...
const Hero = () => {
  return (
    <section className="hero">
      <div className="hero-background" style={{ backgroundImage: 'url(/hero_background_updated.png)' }}></div>
      <div className="container hero-content animate-fade-in">
        ...
        <button className="primary-cta glass-panel">Join Our Community</button>
      </div>
    </section>
  );
};
